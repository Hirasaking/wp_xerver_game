...
if ( ! function_exists( 'twentyeleven_posted_on' ) ) :
	...
	function twentyeleven_posted_on() {
		printf(
			...
			__( '<span class="sep">編集日 </span><time class="entry-date" datetime="%3$s">%4$s</time><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'twentyeleven' ),
